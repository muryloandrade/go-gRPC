...
const (
	SendMessage_RequestMessage_FullMethodName = "/SendMessage/RequestMessage"
)
...
func (c *sendMessageClient) RequestMessage(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, SendMessage_RequestMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SendMessage_RequestMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SendMessage_RequestMessage_FullMethodName,
	}
